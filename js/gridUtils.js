			...
			var objID = object.objID,
					...
					node = domConstruct.create("div", {
						...
						"innerHTML":"<button class='rm-layer-btn' data-objectid='" + objID + "'> X </button>" +
								...
								"<div class='downloadLink'><a href='" + downloadLink + "' target='_blank'>" + this.config.DOWNLOAD_MAP_LABEL + "</a></div>" +
								saveAsString,
						"onclick":lang.hitch(this, function (evt) {
							...
							if (evt.target.getAttribute("class") === "thumbnailMapName") {
								domConstruct.create("div", {
									...
									"innerHTML":"<button class='rm-tooltip-btn'> X </button>" + author + ", " + citation,
									"onclick":lang.hitch(this, function (evt) {
